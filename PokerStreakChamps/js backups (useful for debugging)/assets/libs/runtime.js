...
function u(t, r, e, n) {
var o = r && r.prototype instanceof v ? r : v, i = Object.create(o.prototype), a = new G(n || []);
i._invoke = _(t, e, a);
return i;
}
t.wrap = u;
...
var h = "suspendedStart", s = "suspendedYield", l = "executing", p = "completed", y = {};
function v() {}
function d() {}
function g() {}
var m = {};
...
var w = Object.getPrototypeOf, L = w && w(w(N([])));
...
t.mark = function(t) {
if (Object.setPrototypeOf) Object.setPrototypeOf(t, g); else {
t.__proto__ = g;
...
if (!t) for (var e in this) "t" === e.charAt(0) && n.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = r);
},
stop: function() {
this.done = !0;
...
var u = n.call(a, "catchLoc"), f = n.call(a, "finallyLoc");
if (u && f) {
...
this.method = "return";
this.next = "end";
} else "normal" === t.type && r && (this.next = r);
return y;
},
finish: function(t) {
...
Function("n", "regeneratorRuntime=n")(runtime);
}